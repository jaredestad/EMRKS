<?php
    ...
    if(mysql_num_rows($result) > 0)
    {
        ...
        while ($row = mysql_fetch_assoc($result)) {
            ...
            echo "<td class='shower' ><textarea id='csymptom' placeholder='Symptoms...' cols='40'>$symptom</textarea></td>";
            echo "<td class='shower' ><textarea id='ctreatment' placeholder='Treatment...' cols='40'>$treatment</textarea></td>";
            if($_SESSION["typeofuser"] == "doctor" || $_SESSION["typeofuser"] == "nurse")
            {
